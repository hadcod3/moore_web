                            ...
                            <TableRow>
                                <TableCell>
                                    <div className='flex gap-4'>
                                        <Image
                                            src='https://utfs.io/f/89d1793a-bc11-4df1-ad69-0603d41d77e9-4ao7e5.png'
                                            alt="item image"
                                            width={120}
                                            height={120}
                                        ...
                                        />
                                        <div>
                                            <h1>Moore Rent ~ Bandar Lampung</h1>
                                            <h1 className='text-2xl font-semibold'>Roll Top</h1>
                                            <p className='text-md text-gray-400'>Stock: 80</p>
                                        </div>
                                    </div>
                                </TableCell>
                                <TableCell>
                                    <Counter initialCount={2} onChange={(value) => checkFunction(itemId, value)} minOrder={1} maxOrder={100}/>
                                </TableCell>
                                <TableCell className='text-lg font-semibold'>Rp 80.000</TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </div>
                ...
                <div>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='flex gap-3'>
                            ...
                            <div className='flex flex-col'>
                                <h1 className='text-md text-ellipsis'>Roll Top</h1>
                                <h4 className='text-lg font-bold'>Rp 80.000</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='flex gap-2'>
                            <Input type='date' disabled placeholder='Add shipping address' className='w-full bg-white border-gray-200 rounded-lg h-[50px] placeholder:text-grey-300 text-md px-5 py-3 focus-visible:ring-transparent focus:ring-transparent !important focus-visible:ring-offset-0 '/>
